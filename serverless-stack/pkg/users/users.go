...
import (
	...
	"github.com/sajal1123/serverless-stack/pkg/validators"
)
...
var (
	...
	ErrorIvalidEmail             = "invalid email"
...
func CreateUser(req events.APIGatewayProxyRequest, tableName string, dynaClient dynamodbiface.DynamoDBAPI) (*User, error) {
	...
	if !validators.IsEmailValid(u.Email) {
		return nil, errors.New(ErrorIvalidEmail)
	}
...
func UpdateUser(req events.APIGatewayProxyRequest, tableName string, dynaClient dynamodbiface.DynamoDBAPI) (*User, error) {
	...
	curr_user, _ := FetchUser(u.Email, tableName, dynaClient)
	if curr_user != nil && len(curr_user.Email) == 0 {
